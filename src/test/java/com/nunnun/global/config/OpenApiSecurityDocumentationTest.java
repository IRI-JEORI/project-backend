...
class OpenApiSecurityDocumentationTest {
    ...
    @Test
    void documentsBearerAuthenticationGlobally() throws Exception {
    ...
    @Test
    void excludesPublicAuthOperationsFromBearerAuthentication() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.paths['/auth/signup'].post.security").isEmpty())
                .andExpect(jsonPath("$.paths['/auth/login'].post.security").isEmpty())
                .andExpect(jsonPath("$.paths['/auth/reissue'].post.security").isEmpty())
